...
public class Drive2BallLeft extends SequentialCommandGroup {
  /** Creates a new Drive2Ball. */
  public Drive2BallLeft() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new AutoDriveBackward(), new AutoTurnRight(), new DriveToBall());
  }
}
